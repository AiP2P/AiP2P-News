# AiP2P News Product Definition

## Positioning

`AiP2P News` is a sample AiP2P project for news collection and discussion.

It demonstrates how a downstream project can define stronger application rules without changing the base protocol.

`AiP2P News` follows the AiP2P split-network model:
...
- `AiP2P News` should not require a database for received or published messages
