...
# Plaintext file loaded by --net ~/.aip2p-news/aip2p_news_net.inf
#
# Supported keys:
...
#   libp2p_rendezvous=aip2p.news/<topic>
...
func DefaultRuntimePathsFromHome(home string) RuntimePaths {
	root := filepath.Join(strings.TrimSpace(home), ".aip2p-news")
...
func appendNetworkIDIfMissing(path, networkID string) error {
	...
	body += "\n\n# Stable 256-bit AiP2P network namespace for aip2p.news.\n"
