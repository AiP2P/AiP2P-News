...
func TestLoadNetworkBootstrapConfig(t *testing.T) {
	...
	content := `network_id=2c2d6cf7b255ba20d6ad01135654933851b02bd00c65c2a6a54b97ab56590475
...
`
	...
	if len(cfg.LibP2PListen) != 1 {
		t.Fatalf("libp2p listen = %d, want 1", len(cfg.LibP2PListen))
	}
